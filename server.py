            ...
            if comando == 'agendar':
                try:
                    ...
                    if hora_agendada <= datetime.datetime.now():
                        cliente.send("Erro: Não é possível agendar para uma data/hora no passado.".encode('utf-8'))
                        continue
                    ...
                    cliente.send("Erro: Formato de data/hora inválido. Use o formato AAAA-MM-DD HH:MM:SS".encode('utf-8'))
